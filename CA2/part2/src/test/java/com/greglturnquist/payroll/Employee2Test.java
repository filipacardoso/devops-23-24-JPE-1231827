...
public class Employee2Test {
    ...
    public void validEmployeeConstructor() throws InstantiationException {
        //act
        Employee2 employee = new Employee2("Frodo", "Baggins", "ring bearer", 1, "email@email.com");
    ...
    public void nullFirstName_invalidEmployeeConstructor() throws InstantiationException {
        ...
        Exception exception = assertThrows( InstantiationException.class, () ->
                new Employee2(null, "Baggins", "ring bearer", 1, "email@email.com")
        );
    ...
    public void nullLastName_invalidEmployeeConstructor() throws InstantiationException {
        ...
        // act
        Exception exception = assertThrows( InstantiationException.class, () ->
                new Employee2("Frodo", null, "ring bearer", 1, "email@email.com")
        );
    ...
    public void nullDescriptionName_invalidEmployeeConstructor() throws InstantiationException {
        ...
        // act
        Exception exception = assertThrows( InstantiationException.class, () ->
                new Employee2("Frodo", "Baggins", null, 1, "email@email.com")
        );
    ...
    public void negativeJobYearsName_invalidEmployeeConstructor() throws InstantiationException {
        ...
        // act
        Exception exception = assertThrows( InstantiationException.class, () ->
                new Employee2("Frodo", "Baggins", "ring bearer", -1, "email@email.com")
        );
    ...
    public void nullEmail_invalidEmployeeConstructor() throws InstantiationException {
        ...
        // act
        Exception exception = assertThrows( InstantiationException.class, () ->
                new Employee2("Frodo", "Baggins", "ring bearer", 1, null)
        );
    ...
    public void emptyEmail_invalidEmployeeConstructor() throws InstantiationException {
        ...
        // act
        Exception exception = assertThrows( InstantiationException.class, () ->
                new Employee2("Frodo", "Baggins", "ring bearer", 1, "")
        );
    ...
    public void emailWithoutArroba_invalidEmployeeConstructor() throws InstantiationException {
        ...
        // act
        Exception exception = assertThrows( InstantiationException.class, () ->
                new Employee2("Frodo", "Baggins", "ring bearer", 1, "email.com")
        );
    ...
    public void emailWithoutDot_invalidEmployeeConstructor() throws InstantiationException {
        ...
        // act
        Exception exception = assertThrows( InstantiationException.class, () ->
                new Employee2("Frodo", "Baggins", "ring bearer", 1, "email@emailcom")
        );
    ...
    public void emailStartWithArroba_invalidEmployeeConstructor() throws InstantiationException {
        ...
        // act
        Exception exception = assertThrows( InstantiationException.class, () ->
                new Employee2("Frodo", "Baggins", "ring bearer", 1, "@emailcom")
        );
